...
attach_function :malloc, :malloc, %i[size_t], :pointer
attach_function :calloc, :calloc, %i[size_t size_t], :pointer
attach_function :realloc, :realloc, %i[pointer size_t], :pointer
attach_function :free, :free, %i[pointer], :void
attach_function :posix_memalign, :posix_memalign, %i[pointer size_t size_t], :int32
attach_function :abort, :abort, %i[], :void
attach_function :getenv, :getenv, %i[string], :string
attach_function :realpath, :realpath, %i[string string], :string
...
attach_function :async_message_get_provider_state, :pactffi_async_message_get_provider_state, %i[pointer uint32_t], :pointer
...
attach_function :sync_http_get_provider_state, :pactffi_sync_http_get_provider_state, %i[pointer uint32_t], :pointer
...
attach_function :message_new_from_json, :pactffi_message_new_from_json, %i[uint32_t string int32], :pointer
...
attach_function :message_get_provider_state, :pactffi_message_get_provider_state, %i[pointer uint32_t], :pointer
...
attach_function :sync_message_generate_request_contents, :pactffi_sync_message_generate_request_contents, %i[pointer], :pointer
...
attach_function :sync_message_generate_response_contents, :pactffi_sync_message_generate_response_contents, %i[pointer size_t], :pointer
...
attach_function :sync_message_get_provider_state, :pactffi_sync_message_get_provider_state, %i[pointer uint32_t], :pointer
...
attach_function :new_interaction, :pactffi_new_interaction, %i[uint16 string], :uint32_t
attach_function :new_message_interaction, :pactffi_new_message_interaction, %i[uint16 string], :uint32_t
attach_function :new_sync_message_interaction, :pactffi_new_sync_message_interaction, %i[uint16 string], :uint32_t
attach_function :upon_receiving, :pactffi_upon_receiving, %i[uint32_t string], :bool
attach_function :given, :pactffi_given, %i[uint32_t string], :bool
attach_function :interaction_test_name, :pactffi_interaction_test_name, %i[uint32_t string], :uint32_t
attach_function :given_with_param, :pactffi_given_with_param, %i[uint32_t string string string], :bool
attach_function :given_with_params, :pactffi_given_with_params, %i[uint32_t string string], :int32
attach_function :with_request, :pactffi_with_request, %i[uint32_t string string], :bool
attach_function :with_query_parameter, :pactffi_with_query_parameter, %i[uint32_t string size_t string], :bool
attach_function :with_query_parameter_v2, :pactffi_with_query_parameter_v2, %i[uint32_t string size_t string], :bool
...
attach_function :with_metadata, :pactffi_with_metadata, %i[uint32_t string string int32], :bool
attach_function :with_header, :pactffi_with_header, %i[uint32_t int32 string size_t string], :bool
attach_function :with_header_v2, :pactffi_with_header_v2, %i[uint32_t int32 string size_t string], :bool
attach_function :set_header, :pactffi_set_header, %i[uint32_t int32 string string], :bool
attach_function :response_status, :pactffi_response_status, %i[uint32_t uint16], :bool
attach_function :response_status_v2, :pactffi_response_status_v2, %i[uint32_t string], :bool
attach_function :with_body, :pactffi_with_body, %i[uint32_t int32 string string], :bool
attach_function :with_binary_body, :pactffi_with_binary_body, %i[uint32_t int32 string pointer size_t], :bool
attach_function :with_binary_file, :pactffi_with_binary_file, %i[uint32_t int32 string pointer size_t], :bool
attach_function :with_matching_rules, :pactffi_with_matching_rules, %i[uint32_t int32 string], :bool
attach_function :with_generators, :pactffi_with_generators, %i[uint32_t int32 string], :bool
attach_function :with_multipart_file_v2, :pactffi_with_multipart_file_v2, %i[uint32_t int32 string string string string], :pointer
attach_function :with_multipart_file, :pactffi_with_multipart_file, %i[uint32_t int32 string string string], :pointer
attach_function :set_key, :pactffi_set_key, %i[uint32_t string], :bool
attach_function :set_pending, :pactffi_set_pending, %i[uint32_t bool], :bool
attach_function :set_comment, :pactffi_set_comment, %i[uint32_t string string], :bool
attach_function :add_text_comment, :pactffi_add_text_comment, %i[uint32_t string], :bool
...
attach_function :new_message, :pactffi_new_message, %i[uint16 string], :uint32_t
attach_function :message_expects_to_receive, :pactffi_message_expects_to_receive, %i[uint32_t string], :void
attach_function :message_given, :pactffi_message_given, %i[uint32_t string], :void
attach_function :message_given_with_param, :pactffi_message_given_with_param, %i[uint32_t string string string], :void
attach_function :message_with_contents, :pactffi_message_with_contents, %i[uint32_t string pointer size_t], :void
attach_function :message_with_metadata, :pactffi_message_with_metadata, %i[uint32_t string string], :void
attach_function :message_with_metadata_v2, :pactffi_message_with_metadata_v2, %i[uint32_t string string], :void
attach_function :message_reify, :pactffi_message_reify, %i[uint32_t], :string
...
attach_function :new_async_message, :pactffi_new_async_message, %i[uint16 string], :uint32_t
attach_function :free_pact_handle, :pactffi_free_pact_handle, %i[uint16], :uint32_t
attach_function :free_message_pact_handle, :pactffi_free_message_pact_handle, %i[uint16], :uint32_t
...
attach_function :verifier_broker_source_with_selectors, :pactffi_verifier_broker_source_with_selectors, %i[pointer string string string string uint8 string pointer uint16 string pointer uint16 pointer uint16], :int32
...
attach_function :using_plugin, :pactffi_using_plugin, %i[uint16 string string], :uint32_t
attach_function :cleanup_plugins, :pactffi_cleanup_plugins, %i[uint16], :void
attach_function :interaction_contents, :pactffi_interaction_contents, %i[uint32_t int32 string string], :uint32_t
