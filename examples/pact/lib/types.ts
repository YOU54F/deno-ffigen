...
export namespace PactFfi {
  ...
  export declare function pactffi_mismatches_delete(mismatches: Pointer<StructPointer<"Mismatches">>): void;
  ...
  export declare function pactffi_mismatches_iter_delete(iter: Pointer<StructPointer<"MismatchesIterator">>): void;

  /** /data/input/pact.h#L470 */
  export declare function pactffi_mismatch_to_json(mismatch: Pointer<StructPointer<"Mismatch">>): Pointer<number>;

  /** /data/input/pact.h#L475 */
  export declare function pactffi_mismatch_type(mismatch: Pointer<StructPointer<"Mismatch">>): Pointer<number>;

  /** /data/input/pact.h#L480 */
  export declare function pactffi_mismatch_summary(mismatch: Pointer<StructPointer<"Mismatch">>): Pointer<number>;

  /** /data/input/pact.h#L485 */
  export declare function pactffi_mismatch_description(mismatch: Pointer<StructPointer<"Mismatch">>): Pointer<number>;

  /** /data/input/pact.h#L490 */
  export declare function pactffi_mismatch_ansi_description(mismatch: Pointer<StructPointer<"Mismatch">>): Pointer<number>;
  ...
  export declare function pactffi_parse_pact_json(json: Pointer<number>): Pointer<StructPointer<"Pact">>;

  /** /data/input/pact.h#L651 */
  export declare function pactffi_pact_model_delete(pact: Pointer<StructPointer<"Pact">>): void;

  /** /data/input/pact.h#L689 */
  export declare function pactffi_consumer_get_name(consumer: Pointer<StructPointer<"Consumer">>): Pointer<number>;

  /** /data/input/pact.h#L702 */
  export declare function pactffi_message_new(): Pointer<StructPointer<"Message">>;

  /** /data/input/pact.h#L715 */
  export declare function pactffi_message_new_from_json(index: number, json_str: Pointer<number>, spec_version: PactFfi.PactSpecification): Pointer<StructPointer<"Message">>;

  /** /data/input/pact.h#L730 */
  export declare function pactffi_message_new_from_body(body: Pointer<number>, content_type: Pointer<number>): Pointer<StructPointer<"Message">>;

  /** /data/input/pact.h#L735 */
  export declare function pactffi_message_delete(message: Pointer<StructPointer<"Message">>): void;

  /** /data/input/pact.h#L753 */
  export declare function pactffi_message_get_contents(message: Pointer<StructPointer<"Message">>): Pointer<number>;

  /** /data/input/pact.h#L768 */
  export declare function pactffi_message_set_contents(message: Pointer<StructPointer<"Message">>, contents: Pointer<number>, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L784 */
  export declare function pactffi_message_get_contents_length(message: Pointer<StructPointer<"Message">>): number;

  /** /data/input/pact.h#L800 */
  export declare function pactffi_message_get_contents_bin(message: Pointer<StructPointer<"Message">>): Pointer<number>;

  /** /data/input/pact.h#L815 */
  export declare function pactffi_message_set_contents_bin(message: Pointer<StructPointer<"Message">>, contents: Pointer<number>, len: number, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L837 */
  export declare function pactffi_message_get_description(message: Pointer<StructPointer<"Message">>): Pointer<number>;

  /** /data/input/pact.h#L854 */
  export declare function pactffi_message_set_description(message: Pointer<StructPointer<"Message">>, description: Pointer<number>): number;

  /** /data/input/pact.h#L873 */
  export declare function pactffi_message_get_provider_state(message: Pointer<StructPointer<"Message">>, index: number): Pointer<StructPointer<"ProviderState">>;
  ...
  export declare function pactffi_provider_state_iter_delete(iter: Pointer<StructPointer<"ProviderStateIterator">>): void;

  /** /data/input/pact.h#L931 */
  export declare function pactffi_message_find_metadata(message: Pointer<StructPointer<"Message">>, key: Pointer<number>): Pointer<number>;

  /** /data/input/pact.h#L947 */
  export declare function pactffi_message_insert_metadata(message: Pointer<StructPointer<"Message">>, key: Pointer<number>, value: Pointer<number>): number;
  ...
  export declare function pactffi_message_metadata_iter_delete(iter: Pointer<StructPointer<"MessageMetadataIterator">>): void;
  ...
  export declare function pactffi_message_pact_new_from_json(file_name: Pointer<number>, json_str: Pointer<number>): Pointer<StructPointer<"MessagePact">>;

  /** /data/input/pact.h#L1010 */
  export declare function pactffi_message_pact_delete(message_pact: Pointer<StructPointer<"MessagePact">>): void;
  ...
  export declare function pactffi_message_pact_message_iter_delete(iter: Pointer<StructPointer<"MessagePactMessageIterator">>): void;

  /** /data/input/pact.h#L1103 */
  export declare function pactffi_message_pact_find_metadata(message_pact: Pointer<StructPointer<"MessagePact">>, key1: Pointer<number>, key2: Pointer<number>): Pointer<number>;
  ...
  export declare function pactffi_message_pact_metadata_iter_delete(iter: Pointer<StructPointer<"MessagePactMetadataIterator">>): void;
  ...
  export declare function pactffi_provider_get_name(provider: Pointer<StructPointer<"Provider">>): Pointer<number>;

  /** /data/input/pact.h#L1199 */
  export declare function pactffi_provider_state_get_name(provider_state: Pointer<StructPointer<"ProviderState">>): Pointer<number>;
  ...
  export declare function pactffi_provider_state_delete(provider_state: Pointer<StructPointer<"ProviderState">>): void;

  /** /data/input/pact.h#L1247 */
  export declare function pactffi_provider_state_param_iter_delete(iter: Pointer<StructPointer<"ProviderStateParamIterator">>): void;
  ...
  export declare function pactffi_pact_message_iter_delete(iter: Pointer<StructPointer<"PactMessageIterator">>): void;
  ...
  export declare function pactffi_pact_sync_message_iter_delete(iter: Pointer<StructPointer<"PactSyncMessageIterator">>): void;
  ...
  export declare function pactffi_pact_sync_http_iter_delete(iter: Pointer<StructPointer<"PactSyncHttpIterator">>): void;
  ...
  export declare function pactffi_sync_message_delete(message: Pointer<StructPointer<"SynchronousMessage">>): void;

  /** /data/input/pact.h#L1360 */
  export declare function pactffi_sync_message_get_request_contents(message: Pointer<StructPointer<"SynchronousMessage">>): Pointer<number>;

  /** /data/input/pact.h#L1379 */
  export declare function pactffi_sync_message_set_request_contents(message: Pointer<StructPointer<"SynchronousMessage">>, contents: Pointer<number>, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1395 */
  export declare function pactffi_sync_message_get_request_contents_length(message: Pointer<StructPointer<"SynchronousMessage">>): number;

  /** /data/input/pact.h#L1411 */
  export declare function pactffi_sync_message_get_request_contents_bin(message: Pointer<StructPointer<"SynchronousMessage">>): Pointer<number>;

  /** /data/input/pact.h#L1431 */
  export declare function pactffi_sync_message_set_request_contents_bin(message: Pointer<StructPointer<"SynchronousMessage">>, contents: Pointer<number>, len: number, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1447 */
  export declare function pactffi_sync_message_get_number_responses(message: Pointer<StructPointer<"SynchronousMessage">>): number;

  /** /data/input/pact.h#L1466 */
  export declare function pactffi_sync_message_get_response_contents(message: Pointer<StructPointer<"SynchronousMessage">>, index: number): Pointer<number>;

  /** /data/input/pact.h#L1488 */
  export declare function pactffi_sync_message_set_response_contents(message: Pointer<StructPointer<"SynchronousMessage">>, index: number, contents: Pointer<number>, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1505 */
  export declare function pactffi_sync_message_get_response_contents_length(message: Pointer<StructPointer<"SynchronousMessage">>, index: number): number;

  /** /data/input/pact.h#L1522 */
  export declare function pactffi_sync_message_get_response_contents_bin(message: Pointer<StructPointer<"SynchronousMessage">>, index: number): Pointer<number>;

  /** /data/input/pact.h#L1546 */
  export declare function pactffi_sync_message_set_response_contents_bin(message: Pointer<StructPointer<"SynchronousMessage">>, index: number, contents: Pointer<number>, len: number, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1569 */
  export declare function pactffi_sync_message_get_description(message: Pointer<StructPointer<"SynchronousMessage">>): Pointer<number>;

  /** /data/input/pact.h#L1586 */
  export declare function pactffi_sync_message_set_description(message: Pointer<StructPointer<"SynchronousMessage">>, description: Pointer<number>): number;

  /** /data/input/pact.h#L1606 */
  export declare function pactffi_sync_message_get_provider_state(message: Pointer<StructPointer<"SynchronousMessage">>, index: number): Pointer<StructPointer<"ProviderState">>;
  ...
  export declare function pactffi_sync_http_delete(interaction: Pointer<StructPointer<"SynchronousHttp">>): void;

  /** /data/input/pact.h#L1656 */
  export declare function pactffi_sync_http_get_request_contents(interaction: Pointer<StructPointer<"SynchronousHttp">>): Pointer<number>;

  /** /data/input/pact.h#L1675 */
  export declare function pactffi_sync_http_set_request_contents(interaction: Pointer<StructPointer<"SynchronousHttp">>, contents: Pointer<number>, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1691 */
  export declare function pactffi_sync_http_get_request_contents_length(interaction: Pointer<StructPointer<"SynchronousHttp">>): number;

  /** /data/input/pact.h#L1707 */
  export declare function pactffi_sync_http_get_request_contents_bin(interaction: Pointer<StructPointer<"SynchronousHttp">>): Pointer<number>;

  /** /data/input/pact.h#L1727 */
  export declare function pactffi_sync_http_set_request_contents_bin(interaction: Pointer<StructPointer<"SynchronousHttp">>, contents: Pointer<number>, len: number, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1749 */
  export declare function pactffi_sync_http_get_response_contents(interaction: Pointer<StructPointer<"SynchronousHttp">>): Pointer<number>;

  /** /data/input/pact.h#L1768 */
  export declare function pactffi_sync_http_set_response_contents(interaction: Pointer<StructPointer<"SynchronousHttp">>, contents: Pointer<number>, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1784 */
  export declare function pactffi_sync_http_get_response_contents_length(interaction: Pointer<StructPointer<"SynchronousHttp">>): number;

  /** /data/input/pact.h#L1800 */
  export declare function pactffi_sync_http_get_response_contents_bin(interaction: Pointer<StructPointer<"SynchronousHttp">>): Pointer<number>;

  /** /data/input/pact.h#L1820 */
  export declare function pactffi_sync_http_set_response_contents_bin(interaction: Pointer<StructPointer<"SynchronousHttp">>, contents: Pointer<number>, len: number, content_type: Pointer<number>): void;

  /** /data/input/pact.h#L1842 */
  export declare function pactffi_sync_http_get_description(interaction: Pointer<StructPointer<"SynchronousHttp">>): Pointer<number>;

  /** /data/input/pact.h#L1859 */
  export declare function pactffi_sync_http_set_description(interaction: Pointer<StructPointer<"SynchronousHttp">>, description: Pointer<number>): number;

  /** /data/input/pact.h#L1878 */
  export declare function pactffi_sync_http_get_provider_state(interaction: Pointer<StructPointer<"SynchronousHttp">>, index: number): Pointer<StructPointer<"ProviderState">>;
  ...
  export declare function pactffi_parse_matcher_definition(expression: Pointer<number>): Pointer<StructPointer<"MatchingRuleDefinitionResult">>;

  /** /data/input/pact.h#L1922 */
  export declare function pactffi_matcher_definition_error(definition: Pointer<StructPointer<"MatchingRuleDefinitionResult">>): Pointer<number>;

  /** /data/input/pact.h#L1933 */
  export declare function pactffi_matcher_definition_value(definition: Pointer<StructPointer<"MatchingRuleDefinitionResult">>): Pointer<number>;

  /** /data/input/pact.h#L1938 */
  export declare function pactffi_matcher_definition_delete(definition: Pointer<StructPointer<"MatchingRuleDefinitionResult">>): void;
  ...
  export declare function pactffi_matching_rule_iter_delete(iter: Pointer<StructPointer<"MatchingRuleIterator">>): void;
  ...
  export declare function pactffi_matching_rule_to_json(rule: Pointer<StructPointer<"MatchingRule">>): Pointer<number>;

  /** /data/input/pact.h#L2009 */
  export declare function pactffi_generator_to_json(generator: Pointer<StructPointer<"Generator">>): Pointer<number>;

  /** /data/input/pact.h#L2019 */
  export declare function pactffi_generator_generate_string(generator: Pointer<StructPointer<"Generator">>, context_json: Pointer<number>): Pointer<number>;

  /** /data/input/pact.h#L2030 */
  export declare function pactffi_generator_generate_integer(generator: Pointer<StructPointer<"Generator">>, context_json: Pointer<number>): number;
  ...
  export declare function pactffi_verifier_new_for_application(name: Pointer<number>, version: Pointer<number>): Pointer<StructPointer<"VerifierHandle">>;

  /** /data/input/pact.h#L2896 */
  export declare function pactffi_verifier_shutdown(handle: Pointer<StructPointer<"VerifierHandle">>): void;

  /** /data/input/pact.h#L2908 */
  export declare function pactffi_verifier_set_provider_info(handle: Pointer<StructPointer<"VerifierHandle">>, name: Pointer<number>, scheme: Pointer<number>, host: Pointer<number>, port: number, path: Pointer<number>): void;

  /** /data/input/pact.h#L2929 */
  export declare function pactffi_verifier_add_provider_transport(handle: Pointer<StructPointer<"VerifierHandle">>, protocol: Pointer<number>, port: number, path: Pointer<number>, scheme: Pointer<number>): void;

  /** /data/input/pact.h#L2948 */
  export declare function pactffi_verifier_set_filter_info(handle: Pointer<StructPointer<"VerifierHandle">>, filter_description: Pointer<number>, filter_state: Pointer<number>, filter_no_state: number): void;

  /** /data/input/pact.h#L2969 */
  export declare function pactffi_verifier_set_provider_state(handle: Pointer<StructPointer<"VerifierHandle">>, url: Pointer<number>, teardown: number, body: number): void;

  /** /data/input/pact.h#L2985 */
  export declare function pactffi_verifier_set_verification_options(handle: Pointer<StructPointer<"VerifierHandle">>, disable_ssl_verification: number, request_timeout: bigint): number;

  /** /data/input/pact.h#L3000 */
  export declare function pactffi_verifier_set_coloured_output(handle: Pointer<StructPointer<"VerifierHandle">>, coloured_output: number): number;

  /** /data/input/pact.h#L3014 */
  export declare function pactffi_verifier_set_no_pacts_is_error(handle: Pointer<StructPointer<"VerifierHandle">>, is_error: number): number;

  /** /data/input/pact.h#L3034 */
  export declare function pactffi_verifier_set_publish_options(handle: Pointer<StructPointer<"VerifierHandle">>, provider_version: Pointer<number>, build_url: Pointer<number>, provider_tags: Pointer<Pointer<number>>, provider_tags_len: number, provider_branch: Pointer<number>): number;

  /** /data/input/pact.h#L3050 */
  export declare function pactffi_verifier_set_consumer_filters(handle: Pointer<StructPointer<"VerifierHandle">>, consumer_filters: Pointer<Pointer<number>>, consumer_filters_len: number): void;

  /** /data/input/pact.h#L3062 */
  export declare function pactffi_verifier_add_custom_header(handle: Pointer<StructPointer<"VerifierHandle">>, header_name: Pointer<number>, header_value: Pointer<number>): void;

  /** /data/input/pact.h#L3075 */
  export declare function pactffi_verifier_add_file_source(handle: Pointer<StructPointer<"VerifierHandle">>, file: Pointer<number>): void;

  /** /data/input/pact.h#L3087 */
  export declare function pactffi_verifier_add_directory_source(handle: Pointer<StructPointer<"VerifierHandle">>, directory: Pointer<number>): void;

  /** /data/input/pact.h#L3101 */
  export declare function pactffi_verifier_url_source(handle: Pointer<StructPointer<"VerifierHandle">>, url: Pointer<number>, username: Pointer<number>, password: Pointer<number>, token: Pointer<number>): void;

  /** /data/input/pact.h#L3120 */
  export declare function pactffi_verifier_broker_source(handle: Pointer<StructPointer<"VerifierHandle">>, url: Pointer<number>, username: Pointer<number>, password: Pointer<number>, token: Pointer<number>): void;

  /** /data/input/pact.h#L3147 */
  export declare function pactffi_verifier_broker_source_with_selectors(handle: Pointer<StructPointer<"VerifierHandle">>, url: Pointer<number>, username: Pointer<number>, password: Pointer<number>, token: Pointer<number>, enable_pending: number, include_wip_pacts_since: Pointer<number>, provider_tags: Pointer<Pointer<number>>, provider_tags_len: number, provider_branch: Pointer<number>, consumer_version_selectors: Pointer<Pointer<number>>, consumer_version_selectors_len: number, consumer_version_tags: Pointer<Pointer<number>>, consumer_version_tags_len: number): void;

  /** /data/input/pact.h#L3169 */
  export declare function pactffi_verifier_execute(handle: Pointer<StructPointer<"VerifierHandle">>): number;

  /** /data/input/pact.h#L3220 */
  export declare function pactffi_verifier_cli_args(): Pointer<number>;

  /** /data/input/pact.h#L3229 */
  export declare function pactffi_verifier_logs(handle: Pointer<StructPointer<"VerifierHandle">>): Pointer<number>;
  ...
  export declare function pactffi_verifier_output(handle: Pointer<StructPointer<"VerifierHandle">>, strip_ansi: number): Pointer<number>;

  /** /data/input/pact.h#L3257 */
  export declare function pactffi_verifier_json(handle: Pointer<StructPointer<"VerifierHandle">>): Pointer<number>;
